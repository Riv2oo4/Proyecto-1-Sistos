    ...
    public:
        ...
        void process() {
            try {
                ...
                logger_.record("Parsed participant ID: [" + participant_id_ + "]");
                ...
                logger_.record("Intentando registrar a " + participant_id_);
                logger_.record("ws es nulo? " + std::string(ws == nullptr ? "sí" : "no"));
